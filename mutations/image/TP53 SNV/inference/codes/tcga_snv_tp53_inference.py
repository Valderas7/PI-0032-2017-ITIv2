...
'numpy' """
model = load_model('/mutations/image/TP53 SNV/inference/models/model_image_tp53_06_0.61.h5')

test_image_data = np.load('/mutations/image/TP53 SNV/inference/test data/test_image.npy')
test_labels_tp53 = np.load('/mutations/image/TP53 SNV/inference/test data/test_labels_tp53.npy')
