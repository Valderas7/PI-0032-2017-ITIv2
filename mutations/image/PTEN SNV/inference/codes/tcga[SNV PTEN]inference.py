...
'numpy' """
model = load_model('/home/avalderas/img_slides/mutations/image/PTEN SNV/inference/models/model_image_PTEN_03_0.69.h5')

test_image_data = np.load('/home/avalderas/img_slides/mutations/image/PTEN SNV/inference/test data/normalized/test_image.npy')
test_labels = np.load('/home/avalderas/img_slides/mutations/image/PTEN SNV/inference/test data/normalized/test_labels.npy')
...
print("\n'Loss' de las mutaciones SNV del gen PTEN en el conjunto de prueba: {:.2f}\n""Sensibilidad de las mutaciones "
      ...
      "{:.2f}% \n""Exactitud de las mutaciones SNV del gen PTEN en el conjunto de prueba: {:.2f}%\n""AUC-ROC de las "
