...
'numpy' """
model = load_model('/home/avalderas/img_slides/mutations/image/AKT1 SNV/inference/models/model_image_AKT1_01_1.06.h5')

test_image_data = np.load('/home/avalderas/img_slides/mutations/image/AKT1 SNV/inference/test data/normalized/test_image.npy')
test_labels = np.load('/home/avalderas/img_slides/mutations/image/AKT1 SNV/inference/test data/normalized/test_labels.npy')
...
plot_confusion_matrix(matrix_mutation, classes = matrix_mutation_classes, title ='Matriz de confusión [SNV AKT1]')
plt.show()
