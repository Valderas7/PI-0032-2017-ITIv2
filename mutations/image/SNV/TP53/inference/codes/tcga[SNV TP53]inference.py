...
'numpy' """
model = load_model('/mutations/image/SNV/TP53 SNV/inference/models/model_image_tp53_02_0.59.h5')

test_image_data = np.load('/mutations/image/SNV/TP53 SNV/inference/test data/normalized/test_image.npy')
test_labels_tp53 = np.load('/mutations/image/SNV/TP53 SNV/inference/test data/normalized/test_labels.npy')
