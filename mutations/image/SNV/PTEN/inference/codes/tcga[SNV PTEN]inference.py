...
'numpy' """
model = load_model('/mutations/image/SNV/PTEN SNV/inference/models/model_image_PTEN_03_0.69.h5')

test_image_data = np.load('/mutations/image/SNV/PTEN SNV/inference/test data/normalized/test_image.npy')
test_labels = np.load('/mutations/image/SNV/PTEN SNV/inference/test data/normalized/test_labels.npy')
