...
path = '/home/avalderas/img_slides/mutations/image/SNV/PTEN/inference/models/model_image_PTEN_03_0.69.h5'
model = load_model(path)

""" Se abre WSI especificada y extraemos el paciente del que se trata """
path_wsi = '/media/proyectobdpath/PI0032WEB/P032-HE-193-B_v2.mrxs'
...
plt.savefig('/home/avalderas/img_slides/mutations/image/SNV/PTEN/inference/heatmaps/SNV_PTEN_{}.png'.format(patient_id),
            bbox_inches = 'tight')
#plt.show()