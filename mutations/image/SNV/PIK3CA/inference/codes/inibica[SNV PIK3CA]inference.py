...
path = '/home/avalderas/img_slides/mutations/image/SNV/PIK3CA/inference/models/model_image_pik3ca_01_0.68.h5'
model = load_model(path)

""" Se abre WSI especificada y extraemos el paciente del que se trata """
path_wsi = '/media/proyectobdpath/PI0032WEB/P193-HE-108-5_v2.mrxs'
...
plt.savefig('/home/avalderas/img_slides/mutations/image/SNV/PIK3CA/inference/heatmaps/SNV_PIK3CA_{}.png'.format(patient_id),
            bbox_inches = 'tight')
#plt.show()