...
'numpy' """
model = load_model('/mutations/image/SNV/PIK3CA SNV/inference/models/model_image_pik3ca_01_0.68.h5')

test_image_data = np.load('/mutations/image/SNV/PIK3CA SNV/inference/test data/normalized/test_image.npy')
test_labels_pik3ca = np.load('/mutations/image/SNV/PIK3CA SNV/inference/test data/normalized/test_labels.npy')
