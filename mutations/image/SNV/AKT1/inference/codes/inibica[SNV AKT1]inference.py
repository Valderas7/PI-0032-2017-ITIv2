...
path = '/home/avalderas/img_slides/mutations/image/SNV/AKT1/inference/models/model_image_AKT1_01_1.06.h5'
model = load_model(path)

""" Se abre WSI especificada y extraemos el paciente del que se trata """
path_wsi = '/media/proyectobdpath/PI0032WEB/P105-HE-143-A2_v2.mrxs'
...
plt.savefig('/home/avalderas/img_slides/mutations/image/SNV/AKT1/inference/heatmaps/SNV_AKT1_{}.png'.format(patient_id),
            bbox_inches = 'tight')
#plt.show()