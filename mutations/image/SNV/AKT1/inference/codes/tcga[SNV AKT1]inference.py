...
'numpy' """
model = load_model('/mutations/image/SNV/AKT1 SNV/inference/models/model_image_AKT1_01_1.06.h5')

test_image_data = np.load('/mutations/image/SNV/AKT1 SNV/inference/test data/normalized/test_image.npy')
test_labels = np.load('/mutations/image/SNV/AKT1 SNV/inference/test data/normalized/test_labels.npy')
