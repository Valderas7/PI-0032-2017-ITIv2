...
train_labels_erbb2 = train_data.iloc[:, -1]
valid_labels_erbb2 = valid_data.iloc[:, -1]
test_labels_erbb2 = test_data.iloc[:, -1]
...
checkpoint_path = '/mutations/image/CNV-A/ERBB2 CNV-A/inference/models/model_image_erbb2_{epoch:02d}_{val_loss:.2f}.h5'
