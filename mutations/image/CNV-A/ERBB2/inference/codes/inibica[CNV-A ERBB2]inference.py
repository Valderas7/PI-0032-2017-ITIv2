...
path = '/home/avalderas/img_slides/mutations/image/CNV-A/ERBB2/inference/models/model_image_erbb2_03_0.91.h5'
model = load_model(path)

""" Se abre WSI especificada y extraemos el paciente del que se trata """
path_wsi = '/media/proyectobdpath/PI0032WEB/P020-HE-331-8_v2.mrxs'
...
plt.savefig('/home/avalderas/img_slides/mutations/image/CNV-A/ERBB2/inference/heatmaps/CNV-A_ERBB2_{}.png'.format(patient_id),
            bbox_inches = 'tight')
#plt.show()