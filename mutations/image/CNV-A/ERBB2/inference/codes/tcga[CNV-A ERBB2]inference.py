...
'numpy' """
model = load_model('/mutations/image/CNV-A/ERBB2 CNV-A/inference/models/model_image_erbb2_03_0.91.h5')

test_image_data = np.load('/mutations/image/CNV-A/ERBB2 CNV-A/inference/test data/normalized/test_image.npy')
test_labels_erbb2 = np.load('/mutations/image/CNV-A/ERBB2 CNV-A/inference/test data/normalized/test_labels.npy')
