...
'numpy' """
model = load_model('/mutations/image/CNV-A/FGF3 CNV-A/inference/models/model_image_FGF3_01_0.71.h5')

test_image_data = np.load('/mutations/image/CNV-A/FGF3 CNV-A/inference/test data/normalized/test_image.npy')
test_labels = np.load('/mutations/image/CNV-A/FGF3 CNV-A/inference/test data/normalized/test_labels.npy')
