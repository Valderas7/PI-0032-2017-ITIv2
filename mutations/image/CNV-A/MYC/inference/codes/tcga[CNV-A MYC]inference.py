...
'numpy' """
model = load_model('/mutations/image/CNV-A/MYC CNV-A/inference/models/model_image_myc_01_0.78.h5')

test_image_data = np.load('/mutations/image/CNV-A/MYC CNV-A/inference/test data/normalized/test_image.npy')
test_labels = np.load('/mutations/image/CNV-A/MYC CNV-A/inference/test data/normalized/test_labels.npy')
