...
path = '/home/avalderas/img_slides/mutations/image/CNV-A/MYC/inference/models/model_image_myc_01_0.78.h5'
...
plt.savefig('/home/avalderas/img_slides/mutations/image/CNV-A/MYC/inference/heatmaps/CNV-A_MYC_{}.png'.format(patient_id),
            bbox_inches = 'tight')
#plt.show()