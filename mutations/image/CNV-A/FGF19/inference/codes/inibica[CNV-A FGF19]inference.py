...
path = '/home/avalderas/img_slides/mutations/image/CNV-A/FGF19/inference/models/model_image_FGF19_01_0.71.h5'
model = load_model(path)

""" Se abre WSI especificada y extraemos el paciente del que se trata """
path_wsi = '/media/proyectobdpath/PI0032WEB/P007-HE-140-A2_v2.mrxs'
...
best_level = wsi.get_best_level_for_downsample(4) # Nivel 2 probablemente
...
""" Se itera sobre todas las teselas de tamaño 210x210 de la WSI en el nivel adecuado al factor de magnificación '10x' """
...
plt.savefig('/home/avalderas/img_slides/mutations/image/CNV-A/FGF19/inference/heatmaps/CNV-A_FGF19_{}.png'.format(patient_id),
            bbox_inches = 'tight')
#plt.show()