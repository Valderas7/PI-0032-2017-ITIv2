...
path = '/home/avalderas/img_slides/mutations/image/CNV-A/CCND1/inference/models/model_image_CCND1_01_0.69.h5'
...
plt.savefig('/home/avalderas/img_slides/mutations/image/CNV-A/CCND1/inference/heatmaps/CNV-A_CCND1_{}.png'.format(patient_id),
            bbox_inches = 'tight')
#plt.show()