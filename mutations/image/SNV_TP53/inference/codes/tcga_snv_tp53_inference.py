...
'numpy' """
model = load_model('/home/avalderas/img_slides/mutations/image/SNV_TP53/inference/models/model_image_tp53_03_0.65_roc.h5')
...
if results[5] > 0 or results[6] > 0:
    print("Valor-F de las mutaciones SNV del panel OCA en el conjunto de "
          "prueba: {:.2f}".format((2 * results[5] * results[6]) / (results[5] + results[6])))

""" Para terminar, se calculan las métricas específicas (sensibilidad, precisión, eficacia y especificidad) de estos 
genes sobre los que se van a realizar los mapas de calor. """
