...
if results[9] > 0 or results[10] > 0:
    print("Valor-F de las mutaciones SNV del panel OCA en el conjunto de prueba: {:.2f}".format(
        (2 * results[9] * results[10]) /
...
if results[18] > 0 or results[19] > 0:
    print("Valor-F de las mutaciones CNV-A del panel OCA en el conjunto de prueba: {:.2f}".format(
        (2 * results[18] * results[19]) /
...
if results[36] > 0 or results[37] > 0:
    print("Valor-F de las mutaciones CNV-D del panel OCA en el conjunto de prueba: {:.2f}".format(
        (2 * results[36] * results[37]) /
...
matrix_cnv_a = multilabel_confusion_matrix(y_true_cnv_a,
                                           y_pred_cnv_a)  # Calcula (pero no dibuja) la matriz de confusión
index_cnv_a = 0
...
matrix_cnv_d = multilabel_confusion_matrix(y_true_cnv_d,
                                           y_pred_cnv_d)  # Calcula (pero no dibuja) la matriz de confusión
index_cnv_d = 0
