...
'numpy' """
model = load_model('/home/avalderas/img_slides/mutations/image/FGF3 CNV-A/inference/models/model_image_FGF3_01_0.71.h5')

test_image_data = np.load('/home/avalderas/img_slides/mutations/image/FGF3 CNV-A/inference/test data/normalized/test_image.npy')
test_labels = np.load('/home/avalderas/img_slides/mutations/image/FGF3 CNV-A/inference/test data/normalized/test_labels.npy')
...
plot_confusion_matrix(matrix_mutation, classes = matrix_mutation_classes, title ='Matriz de confusión [CNV-A FGF3]')
plt.show()
