...
'numpy' """
model = load_model('/mutations/image/CNV-D/FANCA CNV-D/inference/models/model_image_FANCA_02_0.63.h5')

test_image_data = np.load('/mutations/image/CNV-D/FANCA CNV-D/inference/test data/normalized/test_image.npy')
test_labels = np.load('/mutations/image/CNV-D/FANCA CNV-D/inference/test data/normalized/test_labels.npy')
