...
path = '/home/avalderas/img_slides/mutations/image/CNV-D/BRCA/inference/models/model_image_BRCA_03_0.69.h5'
...
plt.savefig('/home/avalderas/img_slides/mutations/image/CNV-D/BRCA/inference/heatmaps/CNV-D_BRCA_{}.png'.format(patient_id),
            bbox_inches = 'tight')
#plt.show()