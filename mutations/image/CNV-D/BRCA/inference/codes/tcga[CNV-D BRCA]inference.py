...
'numpy' """
model = load_model('/mutations/image/CNV-D/BRCA CNV-D/inference/models/model_image_BRCA_03_0.69.h5')

test_image_data = np.load('/mutations/image/CNV-D/BRCA CNV-D/inference/test data/normalized/test_image.npy')
test_labels = np.load('/mutations/image/CNV-D/BRCA CNV-D/inference/test data/normalized/test_labels.npy')
