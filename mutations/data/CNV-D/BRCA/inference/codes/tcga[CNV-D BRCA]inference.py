...
'numpy' """
model = load_model('/mutations/data/CNV-D/BRCA CNV-D/inference/models/model_data_BRCA_990_0.65.h5')

test_data = np.load('/mutations/data/CNV-D/BRCA CNV-D/inference/test data/test_data.npy')
test_labels = np.load('/mutations/data/CNV-D/BRCA CNV-D/inference/test data/test_labels.npy')
