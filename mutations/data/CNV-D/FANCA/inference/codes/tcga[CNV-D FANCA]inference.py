...
'numpy' """
model = load_model('/mutations/data/CNV-D/FANCA CNV-D/inference/models/model_data_FANCA_1000_0.63.h5')

test_data = np.load('/mutations/data/CNV-D/FANCA CNV-D/inference/test data/test_data.npy')
test_labels = np.load('/mutations/data/CNV-D/FANCA CNV-D/inference/test data/test_labels.npy')
