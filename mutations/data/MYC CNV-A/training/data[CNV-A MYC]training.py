...
checkpoint_path = '/home/avalderas/img_slides/mutations/data/MYC CNV-A/inference/models/model_data_myc_{epoch:02d}_{val_loss:.2f}.h5'
mcp_save = ModelCheckpoint(filepath = checkpoint_path, monitor = 'val_loss', mode = 'min', save_best_only = True)

""" Una vez definido y compilado el modelo, es hora de entrenarlo. """
neural_network = model.fit(x = train_data, y = train_labels_myc, epochs = 1000, verbose = 1, batch_size = 32,
                           callbacks = mcp_save,
                           validation_data = (valid_data, valid_labels_myc))
