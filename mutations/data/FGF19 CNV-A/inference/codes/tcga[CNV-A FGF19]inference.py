...
'numpy' """
model = load_model('/home/avalderas/img_slides/mutations/data/FGF19 CNV-A/inference/models/model_data_FGF19_1000_0.01.h5')

test_data = np.load('/home/avalderas/img_slides/mutations/data/FGF19 CNV-A/inference/test data/test_data.npy')
test_labels = np.load('/home/avalderas/img_slides/mutations/data/FGF19 CNV-A/inference/test data/test_labels.npy')
