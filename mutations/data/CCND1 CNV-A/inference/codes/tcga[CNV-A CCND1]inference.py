...
'numpy' """
model = load_model('/home/avalderas/img_slides/mutations/data/CCND1 CNV-A/inference/models/model_data_CCND1_903_0.13.h5')

test_data = np.load('/home/avalderas/img_slides/mutations/data/CCND1 CNV-A/inference/test data/test_data.npy')
test_labels = np.load('/home/avalderas/img_slides/mutations/data/CCND1 CNV-A/inference/test data/test_labels.npy')
...
y_pred_CCND1 = np.round(model.predict(test_data))
