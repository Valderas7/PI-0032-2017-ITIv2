...
checkpoint_path = '/home/avalderas/img_slides/mutations/data/CCND1 CNV-A/inference/models/model_data_CCND1_{epoch:02d}_{val_loss:.2f}.h5'
...
neural_network = model.fit(x = train_data, y = train_labels_CCND1, epochs = 1000, verbose = 1, batch_size = 32,
                           #callbacks = [mcp_save, mcp_save_accuracy],
                           validation_data = (valid_data, valid_labels_CCND1))
