...
checkpoint_path = '/home/avalderas/img_slides/mutations/data/PIK3CA SNV/inference/models/model_data_pik3ca_{epoch:02d}_{val_loss:.2f}.h5'
...
neural_network = model.fit(x = train_data, y = train_labels_pik3ca, epochs = 500, verbose = 1, batch_size = 32,
                           # callbacks = [mcp_save, mcp_save_accuracy],
                           validation_data = (valid_data, valid_labels_pik3ca))
