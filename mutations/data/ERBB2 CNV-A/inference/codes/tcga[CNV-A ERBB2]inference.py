...
test_data = np.load('/home/avalderas/img_slides/mutations/data/ERBB2 CNV-A/inference/test data/test_data.npy')
test_labels = np.load('/home/avalderas/img_slides/mutations/data/ERBB2 CNV-A/inference/test data/test_labels.npy')
