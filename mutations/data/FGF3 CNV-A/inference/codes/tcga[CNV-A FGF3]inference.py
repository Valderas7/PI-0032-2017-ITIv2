...
'numpy' """
model = load_model('/home/avalderas/img_slides/mutations/data/FGF3 CNV-A/inference/models/model_data_FGF3_750_0.20.h5')

test_data = np.load('/home/avalderas/img_slides/mutations/data/FGF3 CNV-A/inference/test data/test_data.npy')
test_labels = np.load('/home/avalderas/img_slides/mutations/data/FGF3 CNV-A/inference/test data/test_labels.npy')
