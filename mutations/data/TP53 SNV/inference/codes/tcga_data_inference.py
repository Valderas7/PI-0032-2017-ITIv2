...
test_data = np.load('/home/avalderas/img_slides/mutations/data/TP53 SNV/inference/test data/test_data.npy')
test_labels = np.load('/home/avalderas/img_slides/mutations/data/TP53 SNV/inference/test data/test_labels.npy')
...
plot_confusion_matrix(matrix_pik3ca, classes = matrix_pik3ca_classes, title ='Matriz de confusión [SNV TP53]')
plt.show()
