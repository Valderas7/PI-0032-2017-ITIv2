...
train_labels = train_data.pop('SNV TP53')
valid_labels = valid_data.pop('SNV TP53')
test_labels = test_data.pop('SNV TP53')
...
checkpoint_path = '/home/avalderas/img_slides/mutations/data/TP53 SNV/inference/models/model_data_tp53_{epoch:02d}_{val_loss:.2f}.h5'
