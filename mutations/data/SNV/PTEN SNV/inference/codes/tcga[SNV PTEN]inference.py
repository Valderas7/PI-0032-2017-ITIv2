...
'numpy' """
model = load_model('/mutations/data/SNV/PTEN SNV/inference/models/model_data_PTEN_1000_0.59.h5')

test_data = np.load('/mutations/data/SNV/PTEN SNV/inference/test data/test_data.npy')
test_labels = np.load('/mutations/data/SNV/PTEN SNV/inference/test data/test_labels.npy')
