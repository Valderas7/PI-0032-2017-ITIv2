...
'numpy' """
model = load_model('/mutations/data/SNV/PIK3CA SNV/inference/models/model_data_pik3ca_377_0.68.h5')

test_data = np.load('/mutations/data/SNV/PIK3CA SNV/inference/test data/test_data.npy')
test_labels = np.load('/mutations/data/SNV/PIK3CA SNV/inference/test data/test_labels.npy')
