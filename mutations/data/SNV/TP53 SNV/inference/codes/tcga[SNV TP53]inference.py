...
test_data = np.load('/mutations/data/SNV/TP53 SNV/inference/test data/test_data.npy')
test_labels = np.load('/mutations/data/SNV/TP53 SNV/inference/test data/test_labels.npy')
