...
'numpy' """
model = load_model('/mutations/data/SNV/AKT1 SNV/inference/models/model_data_AKT1_1000_0.67.h5')

test_data = np.load('/mutations/data/SNV/AKT1 SNV/inference/test data/test_data.npy')
test_labels = np.load('/mutations/data/SNV/AKT1 SNV/inference/test data/test_labels.npy')
