...
'numpy' """
model = load_model('/mutations/data/CNV-A/CCND1 CNV-A/inference/models/model_data_CCND1_903_0.13.h5')

test_data = np.load('/mutations/data/CNV-A/CCND1 CNV-A/inference/test data/test_data.npy')
test_labels = np.load('/mutations/data/CNV-A/CCND1 CNV-A/inference/test data/test_labels.npy')
