...
'numpy' """
model = load_model('/mutations/data/CNV-A/FGF3 CNV-A/inference/models/model_data_FGF3_750_0.20.h5')

test_data = np.load('/mutations/data/CNV-A/FGF3 CNV-A/inference/test data/test_data.npy')
test_labels = np.load('/mutations/data/CNV-A/FGF3 CNV-A/inference/test data/test_labels.npy')
