...
'numpy' """
model = load_model('/home/avalderas/img_slides/mutations/data/CNV-A/ERBB2/inference/models/model_data_erbb2_1000_0.60.h5')

test_data = np.load('/home/avalderas/img_slides/mutations/data/CNV-A/ERBB2/inference/test data/test_data.npy')
test_labels = np.load('/home/avalderas/img_slides/mutations/data/CNV-A/ERBB2/inference/test data/test_labels.npy')
...
# Recidivas
y_true_erbb2 = test_labels
y_pred_erbb2 = np.round(model.predict(test_data))

matrix_erbb2 = confusion_matrix(y_true_erbb2, y_pred_erbb2, labels = [0, 1])
matrix_erbb2_classes = ['Sin mutación', 'Con mutación']

plot_confusion_matrix(matrix_erbb2, classes = matrix_erbb2_classes, title ='Matriz de confusión [CNV-A ERBB2]')
plt.show()
