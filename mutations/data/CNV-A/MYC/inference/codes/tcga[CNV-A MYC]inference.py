...
'numpy' """
model = load_model('/mutations/data/CNV-A/MYC CNV-A/inference/models/model_data_myc_697_0.62.h5')

test_data = np.load('/mutations/data/CNV-A/MYC CNV-A/inference/test data/test_data.npy')
test_labels = np.load('/mutations/data/CNV-A/MYC CNV-A/inference/test data/test_labels.npy')
