...
'numpy' """
model = load_model('/mutations/data/CNV-A/FGF19 CNV-A/inference/models/model_data_FGF19_1000_0.01.h5')

test_data = np.load('/mutations/data/CNV-A/FGF19 CNV-A/inference/test data/test_data.npy')
test_labels = np.load('/mutations/data/CNV-A/FGF19 CNV-A/inference/test data/test_labels.npy')
