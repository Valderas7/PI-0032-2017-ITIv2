...
checkpoint_path = '/home/avalderas/img_slides/mutations/image&data/FGF19 CNV-A/inference/models/model_image&data_FGF19_{epoch:02d}_{val_loss:.2f}.h5'
...
model.fit(x = [train_data, train_image_data], y = train_labels_FGF19, epochs = 2, verbose = 1,
