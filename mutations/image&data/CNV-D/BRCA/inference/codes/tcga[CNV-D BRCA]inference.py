...
'numpy' """
model = load_model('/mutations/image&data/BRCA/inference/models/model_image&data_BRCA_02_0.72.h5')

test_data = np.load('/mutations/image&data/BRCA/inference/test data/normalized/test_data.npy')
test_image = np.load('/mutations/image&data/BRCA/inference/test data/normalized/test_image.npy')
test_labels = np.load('/mutations/image&data/BRCA/inference/test data/normalized/test_labels.npy')
