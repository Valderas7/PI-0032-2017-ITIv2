...
'numpy' """
model = load_model('/mutations/image&data/FANCA/inference/models/model_image&data_FANCA_03_0.69.h5')

test_data = np.load('/mutations/image&data/FANCA/inference/test data/normalized/test_data.npy')
test_image = np.load('/mutations/image&data/FANCA/inference/test data/normalized/test_image.npy')
test_labels = np.load('/mutations/image&data/FANCA/inference/test data/normalized/test_labels.npy')
