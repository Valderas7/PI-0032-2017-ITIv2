...
'numpy' """
model = load_model('/mutations/image&data/FGF3/inference/models/model_image&data_FGF3_07_0.62.h5')

test_data = np.load('/mutations/image&data/FGF3/inference/test data/normalized/test_data.npy')
test_image = np.load('/mutations/image&data/FGF3/inference/test data/normalized/test_image.npy')
test_labels = np.load('/mutations/image&data/FGF3/inference/test data/normalized/test_labels.npy')
