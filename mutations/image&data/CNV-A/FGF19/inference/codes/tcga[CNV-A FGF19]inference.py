...
'numpy' """
model = load_model('/mutations/image&data/FGF19/inference/models/model_image&data_FGF19_02_0.63.h5')

test_data = np.load('/mutations/image&data/FGF19/inference/test data/normalized/test_data.npy')
test_image = np.load('/mutations/image&data/FGF19/inference/test data/normalized/test_image.npy')
test_labels = np.load('/mutations/image&data/FGF19/inference/test data/normalized/test_labels.npy')
...
plot_confusion_matrix(matrix, classes = matrix_classes, title ='Matriz de confusión [CNV-A FGF19]')
plt.show()
