...
'numpy' """
model = load_model('/mutations/image&data/MYC/inference/models/model_image&data_myc_01_0.69.h5')

test_data = np.load('/mutations/image&data/MYC/inference/test data/normalized/test_data.npy')
test_image = np.load('/mutations/image&data/MYC/inference/test data/normalized/test_image.npy')
test_labels = np.load('/mutations/image&data/MYC/inference/test data/normalized/test_labels.npy')
...
print("\n'Loss' de las mutaciones CNV-A del gen MYC en el conjunto de prueba: {:.2f}\n""Sensibilidad de las mutaciones "
      ...
      "{:.2f}% \n""Exactitud de las mutaciones CNV-A del gen MYC en el conjunto de prueba: {:.2f}%\n""AUC-ROC de las "
      "mutaciones CNV-A del gen MYC en el conjunto de prueba: {:.2f}\nAUC-PR de las mutaciones CNV-A del gen MYC en "
...
if results[5] > 0 or results[6] > 0:
    print("Valor-F de las mutaciones CNV-A del gen MYC en el conjunto de "
