...
'numpy' """
model = load_model('/mutations/image&data/ERBB2/inference/models/model_image&data_erbb2_01_0.67.h5')

test_data = np.load('/mutations/image&data/ERBB2/inference/test data/normalized/test_data.npy')
test_image = np.load('/mutations/image&data/ERBB2/inference/test data/normalized/test_image.npy')
test_labels = np.load('/mutations/image&data/ERBB2/inference/test data/normalized/test_labels.npy')
