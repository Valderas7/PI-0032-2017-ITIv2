...
checkpoint_path = '/home/avalderas/img_slides/mutations/image&data/FANCA CNV-D/inference/models/model_image&data_FANCA_{epoch:02d}_{val_loss:.2f}.h5'
mcp_loss = ModelCheckpoint(filepath = checkpoint_path, monitor = 'val_loss', mode = 'min', save_best_only = True)

""" Una vez definido el modelo, se entrena: """
model.fit(x = [train_data, train_image_data], y = train_labels, epochs = 6, verbose = 1,
...
neural_network = model.fit(x = [train_data, train_image_data], y = train_labels, epochs = 15, verbose = 1,
                           validation_data = ([valid_data, valid_image_data], valid_labels),
                           #callbacks = mcp_loss,
                           steps_per_epoch = (train_image_data_len / batch_dimension),
                           validation_steps = (valid_image_data_len / batch_dimension))
