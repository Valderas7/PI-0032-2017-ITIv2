...
'numpy' """
model = load_model('/home/avalderas/img_slides/mutations/image&data/BRCA CNV-D/inference/models/model_image&data_BRCA_02_0.72.h5')

test_data = np.load('/home/avalderas/img_slides/mutations/image&data/BRCA CNV-D/inference/test data/normalized/test_data.npy')
test_image = np.load('/home/avalderas/img_slides/mutations/image&data/BRCA CNV-D/inference/test data/normalized/test_image.npy')
test_labels = np.load('/home/avalderas/img_slides/mutations/image&data/BRCA CNV-D/inference/test data/normalized/test_labels.npy')
...
print("\n'Loss' de las mutaciones CNV-D del gen BRCA en el conjunto de prueba: {:.2f}\n""Sensibilidad de las mutaciones "
      ...
      "conjunto de prueba: {:.2f}%\n""Especificidad de las mutaciones CNV-D del gen BRCA en el conjunto de prueba: "
      "{:.2f}% \n""Exactitud de las mutaciones CNV-D del gen BRCA en el conjunto de prueba: {:.2f}%\n""AUC-ROC de las "
      "mutaciones CNV-D del gen BRCA en el conjunto de prueba: {:.2f}\nAUC-PR de las mutaciones CNV-D del gen BRCA en "
...
if results[5] > 0 or results[6] > 0:
    print("Valor-F de las mutaciones CNV-D del gen BRCA en el conjunto de "
...
plot_confusion_matrix(matrix, classes = matrix_classes, title ='Matriz de confusión [CNV-D BRCA]')
plt.show()
...
plt.title('AUC-ROC curve for CNV-D of BRCA genes')
plt.legend(loc='best')
plt.show()
...
plt.title('AUC-PR curve for CNV-D of BRCA genes')
plt.legend(loc='best')
plt.show()