...
valid_no_tp53_tiles = valid_data['CNV_ERBB2_AMP'].value_counts()[0] # Sin mutación
...
test_no_tp53_tiles = test_data['CNV_ERBB2_AMP'].value_counts()[0] # Sin mutación
...
""" Se extraen los datos de salida de mutación CNV-A de ERBB2 """
train_labels_erbb2 = train_data.pop('CNV_ERBB2_AMP')
valid_labels_erbb2 = valid_data.pop('CNV_ERBB2_AMP')
test_labels_erbb2 = test_data.pop('CNV_ERBB2_AMP')
...
neural_network = model.fit(x = [train_data, train_image_data], y = train_labels_erbb2, epochs = 10, verbose = 1,
                           validation_data = ([valid_data, valid_image_data], valid_labels_erbb2),
                           #callbacks = mcp_save,
                           steps_per_epoch = (train_image_data_len / batch_dimension),
                           validation_steps = (valid_image_data_len / batch_dimension))
