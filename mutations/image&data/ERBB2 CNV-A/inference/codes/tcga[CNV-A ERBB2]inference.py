...
'numpy' """
model = load_model('/home/avalderas/img_slides/mutations/image&data/ERBB2 CNV-A/inference/models/model_image&data_erbb2_01_0.67.h5')

test_data = np.load('/home/avalderas/img_slides/mutations/image&data/ERBB2 CNV-A/inference/test data/normalized/test_data.npy')
test_image = np.load('/home/avalderas/img_slides/mutations/image&data/ERBB2 CNV-A/inference/test data/normalized/test_image.npy')
test_labels = np.load('/home/avalderas/img_slides/mutations/image&data/ERBB2 CNV-A/inference/test data/normalized/test_labels.npy')
...
plot_confusion_matrix(matrix, classes = matrix_classes, title ='Matriz de confusión [CNV-A ERBB2]')
plt.show()
