...
'numpy' """
model = load_model('/home/avalderas/img_slides/mutations/image&data/AKT1 SNV/inference/models/model_image&data_AKT1_01_0.74.h5')

test_data = np.load('/home/avalderas/img_slides/mutations/image&data/AKT1 SNV/inference/test data/normalized/test_data.npy')
test_image = np.load('/home/avalderas/img_slides/mutations/image&data/AKT1 SNV/inference/test data/normalized/test_image.npy')
test_labels = np.load('/home/avalderas/img_slides/mutations/image&data/AKT1 SNV/inference/test data/normalized/test_labels.npy')
...
print("\n'Loss' de las mutaciones SNV del gen AKT1 en el conjunto de prueba: {:.2f}\n""Sensibilidad de las mutaciones "
      "SNV del gen AKT1 en el conjunto de prueba: {:.2f}%\n""Precisión de las mutaciones SNV del gen AKT1 en el "
      "conjunto de prueba: {:.2f}%\n""Especificidad de las mutaciones SNV del gen AKT1 en el conjunto de prueba: "
      "{:.2f}% \n""Exactitud de las mutaciones SNV del gen AKT1 en el conjunto de prueba: {:.2f}%\n""AUC-ROC de las "
      "mutaciones SNV del gen AKT1 en el conjunto de prueba: {:.2f}\nAUC-PR de las mutaciones SNV del gen AKT1 en "
...
if results[5] > 0 or results[6] > 0:
    print("Valor-F de las mutaciones SNV del gen AKT1 en el conjunto de "
...
plot_confusion_matrix(matrix, classes = matrix_classes, title ='Matriz de confusión [SNV AKT1]')
plt.show()
