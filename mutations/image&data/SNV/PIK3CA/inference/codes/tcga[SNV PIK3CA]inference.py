...
'numpy' """
model = load_model('/mutations/image&data/PIK3CA/inference/models/model_image&data_pik3ca_01_0.69.h5')

test_data = np.load('/mutations/image&data/PIK3CA/inference/test data/normalized/test_data.npy')
test_image = np.load('/mutations/image&data/PIK3CA/inference/test data/normalized/test_image.npy')
test_labels = np.load('/mutations/image&data/PIK3CA/inference/test data/normalized/test_labels.npy')
