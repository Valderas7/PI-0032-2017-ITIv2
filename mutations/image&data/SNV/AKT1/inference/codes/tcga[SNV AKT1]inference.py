...
'numpy' """
model = load_model('/mutations/image&data/AKT1/inference/models/model_image&data_AKT1_01_0.74.h5')

test_data = np.load('/mutations/image&data/AKT1/inference/test data/normalized/test_data.npy')
test_image = np.load('/mutations/image&data/AKT1/inference/test data/normalized/test_image.npy')
test_labels = np.load('/mutations/image&data/AKT1/inference/test data/normalized/test_labels.npy')
