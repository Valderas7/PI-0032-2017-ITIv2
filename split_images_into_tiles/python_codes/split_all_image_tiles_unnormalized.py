...
for index_normal_merge, image_merge in enumerate(df_all_merge['img_path']):
    ...
    for index_tile, merge_tile in enumerate(merge_tiles):
        if index_normal_merge < 100:
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]),index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_1/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]),index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 100) and (index_normal_merge < 200):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_2/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 200) and (index_normal_merge < 300):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_3/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 300) and (index_normal_merge < 400):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_4/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 400) and (index_normal_merge < 500):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_5/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 500) and (index_normal_merge < 600):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_6/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 600) and (index_normal_merge < 700):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_7/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 700) and (index_normal_merge < 800):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_8/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 800) and (index_normal_merge < 900):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_9/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 900) and (index_normal_merge < 1000):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_10/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 1000) and (index_normal_merge < 1100):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_11/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 1100) and (index_normal_merge < 1200):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_12/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 1200) and (index_normal_merge < 1300):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_13/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 1300) and (index_normal_merge < 1400):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_14/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 1400) and (index_normal_merge < 1500):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_15/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 1500) and (index_normal_merge < 1600):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_16/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 1600) and (index_normal_merge < 1700):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_17/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 1700) and (index_normal_merge < 1800):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_18/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 1800) and (index_normal_merge < 1900):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_19/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
        if (index_normal_merge >= 1900) and (index_normal_merge < 2000):
            print('tile_{}_img{}_n{}'.format(str(series_img.index.values[0]), index_normal_merge, index_tile))
            cv2.imwrite('/home/avalderas/img_slides/split_images_into_tiles/img_lotes_tiles_unnormalized/img_lotes_tiles_un_20/tile_{}_img{}_n{}.JPG'.format(str(series_img.index.values[0]), index_normal_merge, index_tile), merge_tile)
