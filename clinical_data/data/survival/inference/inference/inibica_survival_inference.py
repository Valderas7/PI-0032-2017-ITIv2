...
data_inibica_survival = pd.read_excel('/home/avalderas/img_slides/patient_status/data/overall_status/inference/test_data&models/inference_inibica_survival.xlsx',
                             engine='openpyxl')

""" Ahora habria que eliminar la columna de pacientes y guardar la columna de supervivencia como variable de salida. """
data_inibica_survival = data_inibica_survival.drop(['Paciente'], axis = 1)
inibica_labels = data_inibica_survival.pop('Estado_supervivencia')
