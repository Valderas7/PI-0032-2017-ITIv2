...
model = load_model('/home/avalderas/img_slides/cnv&snv_mutations/snv/training_codes/model_snv_MTOR_epoch06.h5')

#np.load('test_data', test_tabular_data)
test_tabular_data = np.load('/home/avalderas/img_slides/cnv&snv_mutations/snv/inferencia/test_data/image&data/test_data.npy')
test_image_data = np.load('/home/avalderas/img_slides/cnv&snv_mutations/snv/inferencia/test_data/image&data/test_image.npy')
test_labels = np.load('/home/avalderas/img_slides/cnv&snv_mutations/snv/inferencia/test_data/image&data/test_labels.npy')
