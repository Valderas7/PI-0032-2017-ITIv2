...
# data_inibica.to_excel('inference_inibica_mutations-anatomopathologic.xlsx')
...
test_labels_tumor_type = data_inibica_complete.iloc[:, -46:-39]
test_labels_STAGE = data_inibica_complete.iloc[:, -39:-29]
test_labels_pT = data_inibica_complete.iloc[:, -29:-19]
test_labels_pN = data_inibica_complete.iloc[:, -19:-8]
test_labels_pM = data_inibica_complete.iloc[:, -8:-5]
test_labels_IHQ = data_inibica_complete.iloc[:, -5:]
