...
'numpy' """
model = load_model('/correlations/mutations-anatomopathologic/inference/test_data/mutations-anatomopathologic.h5')

test_tabular_data = np.load('/correlations/mutations-anatomopathologic/inference/test_data/test_data.npy')

test_labels_tumor_type = np.load(
    '/correlations/mutations-anatomopathologic/inference/test_data/test_labels_tumor_type.npy')
test_labels_STAGE = np.load('/correlations/mutations-anatomopathologic/inference/test_data/test_labels_STAGE.npy')
test_labels_pT = np.load('/correlations/mutations-anatomopathologic/inference/test_data/test_labels_pT.npy')
test_labels_pN = np.load('/correlations/mutations-anatomopathologic/inference/test_data/test_labels_pN.npy')
test_labels_pM = np.load('/correlations/mutations-anatomopathologic/inference/test_data/test_labels_pM.npy')
test_labels_IHQ = np.load('/correlations/mutations-anatomopathologic/inference/test_data/test_labels_IHQ.npy')
