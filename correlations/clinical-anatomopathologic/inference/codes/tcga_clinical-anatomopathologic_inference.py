...
Para empezar, se itera sobre todas las verdades fundamentales de cada paciente para cada parámetro (pT, IHQ, pN, etc.), 
para almacenar cual es el índice más alto del vector fila en cada paciente, y por tanto, cual es la clase predominante. 
Una vez hecho esto, se comparan los índices más altos de las verdades fundamentales y de las predicciones para realizar
la matriz de confusión para cada parámetro. """
# Tipo histológico
y_true_tumor_type = []
