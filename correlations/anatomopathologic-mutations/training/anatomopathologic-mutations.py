...
--------------------------------------------------------------------------------------------------------------------"""
# 1) Datos anatomopatológicos: Tipo histológico, STAGE, pT, pN, pM, IHQ.
...
cols = cols[:1] + cols[238:] + cols[1:238]
...
""" Se dividen los datos de anatomía patológica y las mutaciones en datos de entrada y datos de salida."""
train_labels_snv = train_tabular_data.iloc[:, 46:197]
valid_labels_snv = valid_tabular_data.iloc[:, 46:197]
test_labels_snv = test_tabular_data.iloc[:, 46:197]

train_labels_cnv_a = train_tabular_data.iloc[:, 197::2]
valid_labels_cnv_a = valid_tabular_data.iloc[:, 197::2]
test_labels_cnv_a = test_tabular_data.iloc[:, 197::2]

train_labels_cnv_d = train_tabular_data.iloc[:, 198::2]
valid_labels_cnv_d = valid_tabular_data.iloc[:, 198::2]
test_labels_cnv_d = test_tabular_data.iloc[:, 198::2]

train_tabular_data = train_tabular_data.iloc[:, :46]
valid_tabular_data = valid_tabular_data.iloc[:, :46]
test_tabular_data = test_tabular_data.iloc[:, :46]
...
checkpoint_path = '/correlations/anatomopathologic-mutations/inference/test_data/anatomopathologic-mutations.h5'
