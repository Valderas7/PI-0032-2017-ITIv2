...
test_tabular_data = np.load('/correlations/clinical-mutations/inference/test_data/test_data.npy')

test_labels_snv = np.load('/correlations/clinical-mutations/inference/test_data/test_labels_snv.npy')
test_labels_cnv_a = np.load('/correlations/clinical-mutations/inference/test_data/test_labels_cnv_a.npy')
test_labels_cnv_d = np.load('/correlations/clinical-mutations/inference/test_data/test_labels_cnv_d.npy')
