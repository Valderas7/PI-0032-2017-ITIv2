...
test_tabular_data = np.load('/home/avalderas/img_slides/correlations/clinical-mutations/inference/test_data&models/test_data.npy')

test_labels_snv = np.load('/home/avalderas/img_slides/correlations/clinical-mutations/inference/test_data&models/test_labels_snv.npy')
test_labels_cnv_a = np.load('/home/avalderas/img_slides/correlations/clinical-mutations/inference/test_data&models/test_labels_cnv_a.npy')
test_labels_cnv_d = np.load('/home/avalderas/img_slides/correlations/clinical-mutations/inference/test_data&models/test_labels_cnv_d.npy')
...
for matrix_gen_snv in matrix_snv:
    ...
    #plt.savefig('/home/avalderas/img_slides/screenshots/correlations/clinical - mutations/tcga/SNV/{}'.format(classes_snv[index_snv].split('_')[1]), bbox_inches='tight')
    plt.show()
    plt.pause(0.2)
...
for matrix_gen_cnv_a in matrix_cnv_a:
    ...
    #plt.savefig('/home/avalderas/img_slides/screenshots/correlations/clinical - mutations/tcga/CNV-A/{}'.format(classes_cnv_a[index_cnv_a].split('_')[1]), bbox_inches='tight')
    plt.show()
    plt.pause(0.2)
...
for matrix_gen_cnv_d in matrix_cnv_d:
    ...
    #plt.savefig('/home/avalderas/img_slides/screenshots/correlations/clinical - mutations/tcga/CNV-D/{}'.format(classes_cnv_d[index_cnv_d].split('_')[1]), bbox_inches='tight')
    plt.show()
    plt.pause(0.2)
