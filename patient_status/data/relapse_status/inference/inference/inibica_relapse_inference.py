...
data_inibica.loc[(data_inibica['Tipo_tumor'] == 'Apocrine') | (data_inibica['Tipo_tumor'] == 'Papillary')
                 | (data_inibica['Tipo_tumor'] == 'Tubular')
                 | (data_inibica['Tipo_tumor'] == 'Medullary'), 'Tumor_Other'] = 1
...
data_inibica = data_inibica[['Paciente', 'Edad', 'Tratamiento_neoadyuvante', 'Diagnóstico_previo', 'SNV_AKT1',
                             ...
                             'CNV_CCNE1_NORMAL', 'CNV_CCNE1_DEL', 'CNV_CDK2_AMP', 'CNV_CDK2_NORMAL', 'CNV_CDK2_DEL',
                             'CNV_CDK4_AMP', 'CNV_CDK4_NORMAL', 'CNV_CDK4_DEL', 'CNV_CDK6_AMP', 'CNV_CDK6_NORMAL',
                             'CNV_CDK6_DEL', 'CNV_EGFR_AMP', 'CNV_EGFR_NORMAL', 'CNV_EGFR_DEL', 'CNV_ERBB2_AMP',
                             'CNV_ERBB2_NORMAL', 'CNV_ERBB2_DEL', 'CNV_ESR1_AMP', 'CNV_ESR1_NORMAL', 'CNV_ESR1_DEL',
                             'CNV_FGF19_AMP', 'CNV_FGF19_NORMAL', 'CNV_FGF19_DEL', 'CNV_FGF3_AMP', 'CNV_FGF3_NORMAL',
                             'CNV_FGF3_DEL', 'CNV_FGFR1_AMP', 'CNV_FGFR1_NORMAL', 'CNV_FGFR1_DEL', 'CNV_FGFR2_AMP',
                             'CNV_FGFR2_NORMAL', 'CNV_FGFR2_DEL', 'CNV_FGFR3_AMP', 'CNV_FGFR3_NORMAL', 'CNV_FGFR3_DEL',
                             'CNV_FGFR4_AMP', 'CNV_FGFR4_NORMAL', 'CNV_FGFR4_DEL', 'CNV_FLT3_AMP', 'CNV_FLT3_NORMAL',
                             'CNV_FLT3_DEL', 'CNV_IGF1R_AMP', 'CNV_IGF1R_NORMAL', 'CNV_IGF1R_DEL', 'CNV_KIT_AMP',
                             'CNV_KIT_NORMAL', 'CNV_KIT_DEL', 'CNV_KRAS_AMP', 'CNV_KRAS_NORMAL', 'CNV_KRAS_DEL',
                             'CNV_MDM2_AMP', 'CNV_MDM2_NORMAL', 'CNV_MDM2_DEL', 'CNV_MDM4_AMP', 'CNV_MDM4_NORMAL',
                             'CNV_MDM4_DEL', 'CNV_MET_AMP', 'CNV_MET_NORMAL', 'CNV_MET_DEL', 'CNV_MYC_AMP',
...
data_inibica_relapse = pd.read_excel('/home/avalderas/img_slides/patient_status/data/relapse_status/inference/test_data&models/inference_inibica_relapse.xlsx',
                                     engine='openpyxl')

""" Ahora habria que eliminar la columna de pacientes y guardar la columna de recidivas como variable de salida. """
data_inibica_relapse = data_inibica_relapse.drop(['Paciente'], axis = 1)
inibica_labels = data_inibica_relapse.pop('Recidivas')

""" Se transforman ambos dataframes en formato numpy para que se les pueda aplicar la inferencia del modelo de la red 
neuronal """
test_data_inibica = np.asarray(data_inibica_relapse).astype('float32')
inibica_labels = np.asarray(inibica_labels)

relapse_model = load_model('/home/avalderas/img_slides/patient_status/data/relapse_status/inference/test_data&models/data_model_relapse_prediction.h5')
