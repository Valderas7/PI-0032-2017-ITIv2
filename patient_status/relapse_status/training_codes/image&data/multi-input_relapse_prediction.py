...
df_list = [df_age, df_neoadjuvant, df_path_m_stage, df_path_n_stage, df_path_t_stage, df_stage, df_subtype,
           df_tumor_type, df_prior_diagnosis, df_dfs_status, df_snv, df_cnv]
...
""" Se extrae la columna 'dfs_status' del dataframe de todos los subconjuntos, puesto que ésta es la salida del modelo 
...
checkpoint_path = 'model_multi-input_relapse_prediction_epoch{epoch:02d}.h5'
