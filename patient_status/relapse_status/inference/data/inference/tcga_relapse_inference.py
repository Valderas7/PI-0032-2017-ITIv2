...
model = load_model('/home/avalderas/img_slides/patient_status/relapse_status/inference/data/test_data&models/data_model_relapse_prediction.h5')

test_tabular_data = np.load('/home/avalderas/img_slides/patient_status/relapse_status/inference/data/test_data&models/test_data.npy')
test_labels = np.load('/home/avalderas/img_slides/patient_status/relapse_status/inference/data/test_data&models/test_labels.npy')
