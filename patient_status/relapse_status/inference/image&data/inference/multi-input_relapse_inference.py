...
model = load_model('/home/avalderas/img_slides/patient_status/relapse_status/inference/image&data/test_data&models/model_snv_image_tp53_epoch02.h5')

test_tabular_data = np.load('/home/avalderas/img_slides/patient_status/relapse_status/inference/image&data/test_data&models/test_data.npy')
test_image_data = np.load('/home/avalderas/img_slides/patient_status/relapse_status/inference/image&data/test_data&models/test_image.npy')
test_labels = np.load('/home/avalderas/img_slides/patient_status/relapse_status/inference/image&data/test_data&models/test_labels.npy')
