...
model = load_model('/home/avalderas/img_slides/patient_status/overall_status/inference/image/test_data&models/model_image_survival_prediction.h5')

test_image_data = np.load('/home/avalderas/img_slides/patient_status/overall_status/inference/image/test_data&models/test_image.npy')
test_labels = np.load('/home/avalderas/img_slides/patient_status/overall_status/inference/image/test_data&models/test_labels.npy')
