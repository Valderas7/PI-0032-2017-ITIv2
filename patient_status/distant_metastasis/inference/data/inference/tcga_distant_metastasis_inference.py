...
model = load_model('/home/avalderas/img_slides/patient_status/distant_metastasis/inference/data/test_data&models/data_model_distant_metastasis_prediction.h5')

test_tabular_data = np.load('/home/avalderas/img_slides/patient_status/distant_metastasis/inference/data/test_data&models/test_data.npy')
test_labels = np.load('/home/avalderas/img_slides/patient_status/distant_metastasis/inference/data/test_data&models/test_labels.npy')
