...
cols = cols[:2] + cols[4:5] + cols[3:4] + cols[-18:] + cols[5:6] + cols[6:-18] + cols[2:3]
...
data_inibica_relapse = pd.read_excel('/home/avalderas/img_slides/clinical/data/relapse/inference/excel/inference_inibica_relapse.xlsx', engine='openpyxl')
...
test_labels = data_inibica.pop('Recidivas')
