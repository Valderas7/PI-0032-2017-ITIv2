...
'numpy' """
model = load_model('/home/avalderas/img_slides/clinical/image&data/survival/inference/models/model_image&data_survival_01_0.69.h5')

test_data = np.load('/home/avalderas/img_slides/clinical/image&data/survival/inference/test data/normalized/test_data.npy')
test_image = np.load('/home/avalderas/img_slides/clinical/image&data/survival/inference/test data/normalized/test_image.npy')
test_labels = np.load('/home/avalderas/img_slides/clinical/image&data/survival/inference/test data/normalized/test_labels.npy')
...
y_pred_survival = np.round(model.predict([test_data,test_image]))

matrix_survival = confusion_matrix(y_true_survival, y_pred_survival, labels = [0, 1])
matrix_survival_classes = ['Vive', 'Fallece']
...
y_pred_prob_survival = model.predict([test_data, test_image]).ravel()
