...
df_all_merge = df_all_merge.rename(columns = {'os_status': 'Survival', 'dfs_status': 'Relapse',
                                              ...
                                              'stage_STAGE IIIC': 'STAGE IIIC', 'stage_STAGE X': 'STAGE X'})
...
""" Se iguala el número de teselas con y sin recaída """
# Entrenamiento
...
""" Se extraen los datos de salida de la red neuronal y se guardan en otra variable. Se extran los nombres de las
columnas de datos """
...
result = permutation_importance(forest, train_data, train_labels_relapse, n_repeats = 30, random_state = 42, n_jobs = 2)
