...
'numpy' """
model = load_model('/home/avalderas/img_slides/clinical/image/survival/inference/models/model_image_survival_27_0.55_normalized.h5')

test_image_data = np.load('/home/avalderas/img_slides/clinical/image/survival/inference/test data/test_image_normalized.npy')
test_labels_survival = np.load('/home/avalderas/img_slides/clinical/image/survival/inference/test data/test_labels_survival_normalized.npy')
