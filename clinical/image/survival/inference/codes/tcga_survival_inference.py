...
'numpy' """
model = load_model('/home/avalderas/img_slides/clinical/image/survival/inference/models/model_image_survival_04_0.68.h5')

test_image_data = np.load('/home/avalderas/img_slides/clinical/image/survival/inference/test data/normalized/test_image_normalized.npy')
test_labels_survival = np.load('/home/avalderas/img_slides/clinical/image/survival/inference/test data/normalized/test_labels_normalized.npy')
