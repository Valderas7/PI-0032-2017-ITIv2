...
'numpy' """
model = load_model('/home/avalderas/img_slides/clinical/image/distant metastasis/inference/models/model_image_metastasis_19_0.51_unnormalized.h5')

test_image_data = np.load('/home/avalderas/img_slides/clinical/image/distant metastasis/inference/test data/test_image_unnormalized.npy')
test_labels_metastasis = np.load('/home/avalderas/img_slides/clinical/image/distant metastasis/inference/test data/test_labels_metastasis_unnormalized.npy')
