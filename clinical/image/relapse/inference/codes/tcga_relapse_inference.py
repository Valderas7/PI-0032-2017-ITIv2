...
'numpy' """
model = load_model('/home/avalderas/img_slides/clinical/image/relapse/inference/models/model_image_relapse_05_0.73.h5')

test_image_data = np.load('/home/avalderas/img_slides/clinical/image/relapse/inference/test data/normalized/test_image_normalized.npy')
test_labels_relapse = np.load('/home/avalderas/img_slides/clinical/image/relapse/inference/test data/normalized/test_labels_normalized.npy')
